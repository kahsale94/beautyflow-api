...
- [ ] Alterações revisadas, commitadas e identificadas com uma tag de versão.
- [ ] Pipeline de CI concluído sem falhas.
...
- [ ] Cookies de autenticação estão com `Secure=true`.
...
- [ ] DNS e certificado TLS estão válidos.
...
- [ ] Volumes persistentes do PostgreSQL e Redis estão montados no armazenamento correto.
- [ ] Limites de CPU, memória e disco foram definidos no ambiente de hospedagem.
...
- [ ] Os nove workflows do Beautyflow estão sincronizados e ativos.
- [ ] Todas as credenciais exigidas pelos workflows existem e estão válidas.
- [ ] Créditos e limites dos provedores de IA foram conferidos.
...
- [ ] Node comunitário da Evolution foi testado manualmente na versão instalada do n8n.
- [ ] Uma nova instância foi criada pelo painel sem duplicação.
- [ ] Código QR foi exibido e o WhatsApp conectado.
- [ ] Uma mensagem recebida e uma mensagem enviada percorreram o fluxo completo.
- [ ] Desconexão, reconexão e remoção de instância foram testadas.
