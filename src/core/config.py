...
WHATSAPP_HUMAN_TAKEOVER_TTL_SECONDS = get_optional_int_env("WHATSAPP_HUMAN_TAKEOVER_TTL_SECONDS", 24 * 60 * 60)
WHATSAPP_BOT_AGENT_NAME = os.getenv("WHATSAPP_BOT_AGENT_NAME", "Beautyflow")
