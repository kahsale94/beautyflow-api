...
integration_fk = Annotated[int, mapped_column(ForeignKey("integrations.id", ondelete="cascade"), nullable=False)]
...
client_fk = Annotated[int, mapped_column(ForeignKey("clients.id", ondelete="cascade"), nullable=False)]