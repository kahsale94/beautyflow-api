...
class ScheduleBlockReallocationResponse(BaseModel):
    block: ScheduleBlockResponse
    reassigned_appointment_ids: list[int]
    canceled_appointment_ids: list[int]
    replacement_entitlement_ids: list[int]
